...
public class SavedArticleController {
    ...
    @PostMapping("/create")
    public ApiResponse<SavedArticleResponseDTO> create(@Valid @RequestBody SavedArticleRequestDTO savedArticleRequestDTO) {
        return savedArticleService.create(savedArticleRequestDTO);
    }
    @PreAuthorize(value = "hasRole('ROLE_ADMIN')")
    @PutMapping("/update/{id}")
    public ApiResponse<SavedArticleResponseDTO> update(@PathVariable("Id")String id,@Valid @RequestBody SavedArticleRequestDTO savedArticleRequestDTO) {
        return savedArticleService.update(id,savedArticleRequestDTO);
    }
    @GetMapping("/get/{id}")
    public ApiResponse<SavedArticleResponseDTO> get(@PathVariable("id") String id) {
